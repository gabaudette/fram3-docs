...
description: "live Base class for elements that contain exactly one child element. Use this for wrapper elements that add behavior or styling around a single child, such as padding, alignment, or opacity."
since: "2.0.0-beta.1"
status: "live"
