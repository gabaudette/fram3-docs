---
title: DiffOp
description: "live Represents a single patch operation produced by the tree differ. Operations are applied in order by TreePatcher to transform the existing Node child list to match a new Element child list. This is an internal framework type not intended for direct use."
since: "2.0.0-beta.1"
status: "live"
