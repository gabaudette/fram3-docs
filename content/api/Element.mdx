---
title: Element
description: "The base class for all Fram3 UI descriptions. An Element is an immutable configuration object that describes a piece of user interface. Elements are lightweight and intended to be recreated on every build cycle. The framework uses elements as blueprints to create and update the actual rendered UI through the reconciliation process."
---

# Element

The base class for all Fram3 UI descriptions. An Element is an immutable configuration object that describes a piece of user interface. Elements are lightweight and intended to be recreated on every build cycle. The framework uses elements as blueprints to create and update the actual rendered UI through the reconciliation process.
