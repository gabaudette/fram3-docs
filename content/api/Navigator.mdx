---
title: Navigator
description: "live A stack-based in-scene navigator. Maintains a stack of named routes and renders the topmost route as its content. Descendants can push and pop routes by retrieving the NavigatorHandle via context.GetInherited&lt;NavigatorScope&gt;().Navigator."
since: "2.0.0-beta.1"
status: "live"
