---
title: Store
description: "live A Redux-style reactive state container. Holds a single immutable state value and mutates it exclusively through a pure reducer function that maps the current state and a dispatched FrameAction to a new state."
since: "2.0.0-beta.1"
status: "live"
