...
description: "live Abstracts the persistence mechanism used by PersistentStore. Implement this interface to provide a custom storage back-end. A default PlayerPrefs implementation is provided by PersistentStore when running inside Unity."
since: "2.0.0-beta.1"
status: "live"
