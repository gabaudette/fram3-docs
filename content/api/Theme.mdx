---
title: Theme
description: "An immutable set of design tokens that define the visual language of the application. Pass a theme through the tree with ThemeProvider and read it in any descendant with ThemeConsumer.Of(context)."
---

# Theme

An immutable set of design tokens that define the visual language of the application. Pass a theme through the tree with ThemeProvider and read it in any descendant with ThemeConsumer.Of(context).
