...
description: "live Non-generic interface implemented by all AnimatedValue instances. Used by ImplicitAnimationSnapshot internally to store and interpolate heterogeneous animated values without knowing their concrete types."
since: "2.0.0-beta.1"
status: "live"
