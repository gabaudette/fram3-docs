---
title: FAnimationController
description: "A time-driven animation controller that progresses from 0 to 1 (or 1 to 0) over a configurable duration. The controller applies an easing curve to the raw linear progress before notifying listeners. Create an FAnimationController inside FState.InitState, call Forward or Reverse to start playback, and dispose it inside FState.Dispose. The controller registers itself with FAnimationSystem automatically and is ticked once per frame by Single)."
---
