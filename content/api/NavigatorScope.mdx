...
description: "live An inherited element that carries a NavigatorHandle through the element tree. Descendants retrieve it with context.GetInherited&lt;NavigatorScope&gt;().Navigator."
since: "2.0.0-beta.1"
status: "live"
