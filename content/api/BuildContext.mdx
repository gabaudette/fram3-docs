---
title: BuildContext
description: "live A handle to the location of an element in the element tree. Provides access to ancestor elements and framework services from within a Build method. Each element in the tree receives its own build context, which can be used to look up inherited data or access navigation and state management facilities."
since: "2.0.0-beta.1"
status: "live"
