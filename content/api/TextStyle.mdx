---
title: TextStyle
description: "Describes the visual style of a text label, including font size, color, weight, decoration, alignment, and font asset."
---

# TextStyle

Describes the visual style of a text label, including font size, color, weight, decoration, alignment, and font asset.
...
| `FontAsset` | SDF font asset used for rendering. Null inherits from the parent. Maps to style.unityFontDefinition via FontDefinition.FromSDFFont. |
...
SDF font asset used for rendering. Null inherits from the parent. Maps to style.unityFontDefinition via FontDefinition.FromSDFFont.
