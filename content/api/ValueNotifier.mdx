---
title: ValueNotifier
description: "live Holds a single observable value and notifies listeners when it changes. Use this to share reactive state between parts of the UI that are not directly related in the element tree. Pair with ValueListenableBuilder to rebuild a subtree whenever the value changes."
since: "2.0.0-beta.1"
status: "live"
