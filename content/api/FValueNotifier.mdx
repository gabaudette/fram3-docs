---
title: FValueNotifier
description: "Holds a single observable value and notifies listeners when it changes. Use this to share reactive state between parts of the UI that are not directly related in the element tree. Pair with FValueListenableBuilder to rebuild a subtree whenever the value changes."
---

# FValueNotifier

Holds a single observable value and notifies listeners when it changes. Use this to share reactive state between parts of the UI that are not directly related in the element tree. Pair with FValueListenableBuilder to rebuild a subtree whenever the value changes.
